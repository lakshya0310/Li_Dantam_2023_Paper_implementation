...
class Simulation1:
    def __init__(self, use_gui=False):
        ...
        # Load 3-DOF Robot
        urdf_path = os.path.join(self.THIS_DIR, "3DOFRoboticArm.urdf")
    ...
    def get_start_config(self):
        # 3-DOF format: Pointing safely into the +Y space
        return [1.57, 0.0, 0.0]

    def get_goal_config(self):
        # 3-DOF format: Pointing safely into the -Y space (impossible to reach)
        return [-1.57, 0.0, 0.0]
